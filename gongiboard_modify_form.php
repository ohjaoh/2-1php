    ...
    <body> 
        ...
        <section>
            ...
            <div id="gongiboard_box">
                ...
                ?>
                <!-- <수정하기> 버튼을 클릭했을 때 DB에 저장된 글을 수정할 수 있도록 action 속성을 gongiboard_modify.php?num=<?=$num?>&page=<?=$page?>로 지정. gongiboard_modify.php 파일에서 글 수정 폼 양식의 데이터를 전달받아 DB를 업데이트한다는 의미.  -->
                <form  name="gongiboard_form" method="post" action="gongiboard_modify.php?num=<?= $num ?>&page=<?= $page ?>" enctype="multipart/form-data">
