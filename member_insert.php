...
$sql = "insert into members(id, name, pass, phone_number, gender, represent_image, address, hobby, self_inproduce, musician, level, point) ";
$sql .= "values('$id', '$name', '$pass', '$phone_number', '$gender', '$represent_image','$address', '$hobby', '$self_inproduce', '$musician', 9, 0)";
