        ...
        <section>
            <div id="admin_box">
                ...
                <ul id="board_list">
                    ...
                    <form method="post" action="admin_gongiboard_delete.php">
                        <?php
                        ...
                        <button type="submit">선택된 글 수정(구현실패)</button>
                    </form>
                </ul>
                ...
                <ul id="board_list">
                    ...
                    <form method="post" action="admin_musicboard_delete.php">
                        <?php
                ...
                <ul id="board_list">
                    ...
                    <form method="post" action="admin_freeboard_delete.php">
                        <?php
