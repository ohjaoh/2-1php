    ...
    <body> 
        ...
        <section>
            ...
            <div id="freeboard_box">
                ...
                <ul class="buttons">
                    <li><button onclick="location.href = 'freeboard_list.php?page=<?= $page ?>'">목록</button></li>
                    <li><button onclick="location.href = 'freeboard_modify_form.php?num=<?= $num ?>&page=<?= $page ?>'">수정</button></li>
                    <li><button onclick="location.href = 'freeboard_delete.php?num=<?= $num ?>&page=<?= $page ?>'">삭제</button></li>
