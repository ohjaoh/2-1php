    ...
    <body> 
        ...
        <section>
            ...
            <div id="musicboard_box">
                ...
                $new_hit = $hit + 1;
                $sql = "update musicboard set hit=$new_hit where num=$num";
                ...
                <ul class="buttons">
                    <li><button onclick="location.href = 'musicboard_list.php?page=<?= $page ?>'">목록</button></li>
                    <?php
                    if ($usermusician == 1) {
                        ?>
                        ...
                        ?>
                        <a href="javascript:alert('뮤지션이 아니면 제한됩니다.')"><button>수정</button></a>
                        <a href="javascript:alert('뮤지션이 아니면 제한됩니다.')"><button>삭제</button></a>
                    <?php }
                    ?>
                    <li><button onclick="location.href = 'musicboard_form.php'">글쓰기</button></li>
                </ul>
            </div> <!-- board_box -->
        </section> 
        <footer>
