        ...
        <script>
            function check_input() {
                if (!document.freeboard_form.subject.value)
                         ...
                         * 이상이 없으면 <form>문의 ACTION에 설정한 freeBOARD_INSERT.PHP로 이동. */
                        {
                            alert("제목을 입력하세요!");
    ...
    <body> 
        ...
        <section>
            ...
            <div id="freeboard_box">
                ...
                <form  name="freeboard_form" method="post" action="freeboard_insert.php" enctype="multipart/form-data">
                    <!-- <form> 태그의 name 속성값인 freeboard_form은 check_input()함수에서 사용.
                    ...
                    <ul id="freeboard_form">
                        ...
                        <li>
                            ...
                            사용자가 입력한 제목이 POST 방식인 $_POST["subject"]로 freeboard_insert.php에 전달됨. -->
                        </li>	    	
                        <li id="text_area">	
                            <span class="col1">내용 : </span>
                            <span class="col2">
                                <textarea name="content"></textarea>
                                <!-- 사용자가 입력한 글 내용이 $_POST["content"]로 freeboard_insert.php에 전달 -->
                            </span>
                        </li>
                        <li>
